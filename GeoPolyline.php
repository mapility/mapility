 ...
 * Class GeoPolygon
 *
 * Provide methods to handle polyline fields.
 * @copyright  Cyberspectrum 2011
 * @author     Christian Schiffler <c.schiffler@cyberspectrum.de>
 * @package    Controller
 */
class GeoPolyline extends TextArea
{
	/**
	...
	{
		return parent::generateLabel() . $this->generateImage('system/modules/contaomaps/html/icon.gif', $GLOBALS['TL_LANG']['MSC']['geopicker'], 'style="vertical-align:top; cursor:pointer;" onclick="ContaoMaps.generatePolyline(this, \'ctrl_' . $this->strId . '\', \'\', \'\')"');
	}
